...
describe("Testing create access token API", () => {
	...
	it("Success - will create authorization token & refresh it with the same deviceId - /token /refresh/token", (done) => {
		let params = {
			"noaccesstoken": true,
			"body": {
				"username": 'owner',
	...
	it("Fails - will not refresh with a different deviceId & deletes the refresh token - /token /refresh/token", (done) => {
		let params = {
			"noaccesstoken": true,
			"body": {
				"username": 'owner',
